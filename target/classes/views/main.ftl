                ...
                <ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-this" id="currency">
                                ...
                                <dd>
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                                       data-tab-mpi="m-p-i-4" data-tab="customer_loss/index" target="_self"><i
                                                ...
                                                class="layui-left-nav"> 流失客户管理</span></a>
                                </dd>
                            </#if>
                        </dl>
                    </li>
                                ...
                                <dd>
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                                       data-tab-mpi="m-p-i-6" data-tab="customer_serve/index/2" target="_self"><i
                                                class="fa fa-tachometer"></i><span
                                                class="layui-left-nav"> 生成订单</span></a>
                                </dd>
                            </#if>
                    ...
                    <li class="layui-nav-item">
                        <a href="javascript:;" class="layui-menu-tips"><i class="fa fa-home"></i><span
                                    class="layui-left-nav"> 数据报表</span> <span class="layui-nav-more"></span></a>
                        <dl class="layui-nav-child">
                            </#if>
                                ...
                                <dd>
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                                       data-tab-mpi="m-p-i-10" data-tab="report/3" target="_self"><i
                                                class="fa fa-tachometer"></i><span
                                                class="layui-left-nav"> 新增客户分析</span></a>
                                </dd>
                            </#if>
                                ...
                                <dd>
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                                       data-tab-mpi="m-p-i-10" data-tab="report/2" target="_self"><i
                                                class="fa fa-tachometer"></i><span
                                                class="layui-left-nav"> 重要数据数量的统计分析</span></a>
                                </dd>
                            </#if>
